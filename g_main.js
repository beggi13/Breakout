...
g_main._debugRender = function (ctx) {
    ...
    var y = 350;
    ctx.fillText('FT ' + this._frameTime_ms, 150, y+10);
    ctx.fillText('FD ' + this._frameTimeDelta_ms, 150, y+20);
    ctx.fillText('UU ' + g_prevUpdateDu, 150, y+30); 
    ctx.fillText('FrameSync ON', 150, y+40);
};
